...
import { CONTEXT_TEMPLATE, UI_SPEC_TEMPLATE, CONTRACT_JSON_TEMPLATE, CONTRACT_DETAIL_TEMPLATE, INTEGRATION_TEMPLATE, } from "../core/templates";
    ...
    execute: async (_args, ctx) => {
        ...
        try {
            ...
            if (!(await fileExists(fs, paths.contractJson()))) {
                ...
                await fs.writeFile(paths.contractJson(), JSON.stringify(contractTemplate, null, 2));
            }
